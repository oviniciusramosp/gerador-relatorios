/* Tabler Icons — lista COMPLETA de nomes (kebab-case).
 * GERADO por tools/gen-tabler-icons.mjs a partir de @tabler/icons/icons.json
 * 5130 ícones. Não edite à mão.
 *
 *   node tools/gen-tabler-icons.mjs
 * Uso no HTML: <i class="ti ti-{name}"></i>  (outline)
 *              <i class="ti ti-{name}-filled"></i> (filled, se existir)
 */
